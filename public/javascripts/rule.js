let Rule = {
    ...
    KOMA_BASE: {100:0,101:1,102:2,103:3,104:4,105:5,106:6,107:7,108:8,109:9,110:10,111:11,112:12,113:13,
    ...
    UpdateBoard : function (board,koma,moveFrom,moveTo,isEvolve) {
        if(isEvolve) {
            koma = this.MakeEvolve(koma);
        }
        if(board[moveTo]) {
            board = this.TakeKoma(board,moveTo);
        }
